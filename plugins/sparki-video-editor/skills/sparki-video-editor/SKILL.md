...
> API docs at https://sparki.io/doc/api.
>
...
|---|---|
| `AUTH_FAILED` | "Your API key is invalid. Get a new one from the Sparki API docs at https://sparki.io/doc/api, then run `sparki setup --api-key <key>`." |
